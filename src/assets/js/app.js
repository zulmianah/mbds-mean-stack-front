var App = (function () {
  ...
  var desktopFunctions = {
    activateScroll: function () {
      const desktopFncScroll = new PerfectScrollbar(
        ".menu-categories li.menu .submenu",
        {
          wheelSpeed: 0.5,
          swipeEasing: !0,
          minScrollbarLength: 40,
      ...
      for (var i = 0; i < getDropdownElement.length; i++) {
        getDropdownElement[i].addEventListener("click", function () {
          ...
          document
            ...
            .setAttribute(
              "src",
              "assets/img/" + this.getAttribute("data-img-value") + ".svg"
            );
        });
      }
    },
  ...
  var productionFunctionality = {
    createButtons: function () {
      ...
      element.style.cssText =
        "position: fixed;bottom: 43px;right: 21px;z-index: 1025;";
        ...
        switch (obj.type) {
          case "button":
            ...
            button.style.cssText =
              " margin-left: 6px;padding: 6px 9px; display: none; border: none;box-shadow: 0 10px 20px -10px #4801FF; background-image: linear-gradient(-225deg, #AC32E4 0%, #7918F2 48%, #4801FF 100%);";
          ...
          case "anchor":
            ...
            anchor.style.cssText =
              "border: none; background-image: linear-gradient(to right, #ff0844 20%, #ffb199 141%);box-shadow: 0 10px 20px -10px #ff0844;";
